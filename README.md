...
<!-- IMAGE: Main menu screenshot (docs/menu.PNG already exists in repo) -->
...
<!-- IMAGE: Board grid showing both tile types with mana values. Recreate Fig 1.1 from the documentation or take an in-game screenshot of a fresh board. Suggested filename: docs/board-grid.png -->
...
<!-- IMAGE: Two screenshots side by side — one showing the freeze crystal animation on a tile, one showing the burn fireball animation. Suggested filename: docs/spells.png -->
...
<!-- IMAGE: Victory Lap screen showing the BFS traversal path across remaining tiles with the score panel visible. Suggested filename: docs/victory-lap.png -->
...
<!-- IMAGE: The system architecture and game loop flowchart (Fig 6 from documentation). This can be exported from the docs or recreated. Suggested filename: docs/architecture.png -->
...
<!-- IMAGE: Already available as docs/menu.PNG -->
![Main Menu](docs/menu.PNG)

### Game Board

<!-- IMAGE: In-game screenshot of a 9x9 board mid-match. Already available as docs/board-9x9.PNG -->
![9x9 Game Board](docs/board-9x9.PNG)

<!-- 
Additional screenshots to add to the docs/ folder:

docs/board-5x5.png       - 5x5 board at game start
docs/board-7x7.png       - 7x7 board at game start
docs/movement-phase.png  - Player movement phase with yellow tile highlights
docs/spell-phase.png     - Spell phase with purple targeting highlights
docs/freeze-spell.png    - Freeze crystal animation on a tile
docs/burn-spell.png      - Burn fireball animation mid-flight
docs/burn-frozen.png     - Burn spell landing on a frozen tile
docs/combat-log.png      - Side panel showing mana scores and combat log
docs/victory-lap.png     - Victory Lap screen with BFS traversal visible
docs/game-over-win.png   - "Player Wins!" game over screen
docs/game-over-lose.png  - "AI Wins!" game over screen
docs/game-over-draw.png  - "It's a Draw!" game over screen
docs/architecture.png    - System architecture and game loop flowchart (Fig 6 from documentation)
-->
